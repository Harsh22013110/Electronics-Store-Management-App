    ...
    <ScrollView contentContainerStyle={styles.page}>
      ...
      <View style={styles.row}>
        <View style={styles.flex}>
          <TextInput label="Quantity sold" value={qtyText} onChangeText={setQtyText} keyboardType="number-pad" />
        </View>
        <View style={styles.flex}>
          <TextInput label="Price per piece" value={priceText} onChangeText={setPriceText} keyboardType="numeric" />
        </View>
      </View>
      ...
      <Button
        ...
        onPress={async () => {
          ...
          try {
            setSaving(true);
            const tx = await store.createSale({
              personName: customer,
              companyId: companyId ?? '',
              modelId: modelId ?? '',
              quantity,
